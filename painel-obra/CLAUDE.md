...
### Branch ÚNICA
- O projeto usa **UMA ÚNICA branch**: **`claude/painel-obra-pilot-neqkp0`**.
- O **Netlify publica automaticamente** dessa branch (push = deploy em ~1–2 min).
- **NÃO crie outra branch de trabalho.** Trabalhe, faça commit e push **sempre
  na `neqkp0`**. (Branches antigas de sessões anteriores, como `*-o69lul`, foram
  descontinuadas — se aparecer alguma, ignore/consolide na neqkp0.)
