...
function EtapaFormulario({
  ...
  function mensagemComLink(f: Formulario): string {
    ...
    return [
      ...
      '',
      'Você pode responder da forma que ficar melhor pra você:',
      '1. Preenchendo você mesmo(a), com calma — fica salvo automaticamente, dá pra parar e voltar depois no mesmo link; ou',
      '2. Marcando um call comigo pra respondermos juntos — nesse caso, reserve de *1h a 1h30*.',
      '',
      'Segue o link abaixo:',
